...
import exporterFields from 'modules/bookshelves/list/bookshelvesListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'BOOKSHELVES_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await BookshelvesService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.bookshelves.exporterFileName'),
