    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=book">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: bookSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: bookSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(BookToolbar);
