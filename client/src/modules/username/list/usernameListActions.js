...
import exporterFields from 'modules/username/list/usernameListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'USERNAME_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await UsernameService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.username.exporterFileName'),
