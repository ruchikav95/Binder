...
class UsernameToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=username">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: usernameSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: usernameSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(UsernameToolbar);
