...
import UsernameFormModal from 'view/username/form/UsernameFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/username/usernameSelectors';

class UsernameAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return UsernameService.listAutocomplete(value, limit);
  };
...
export default connect(select)(UsernameAutocompleteFormItem);
