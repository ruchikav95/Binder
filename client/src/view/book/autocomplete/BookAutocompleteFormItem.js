...
import BookFormModal from 'view/book/form/BookFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/book/bookSelectors';

class BookAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return BookService.listAutocomplete(value, limit);
  };
...
export default connect(select)(BookAutocompleteFormItem);
